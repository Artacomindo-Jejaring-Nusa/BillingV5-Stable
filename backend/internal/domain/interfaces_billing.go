...
type InvoiceRepository interface {
	GetAll(ctx context.Context, limit, offset int, search, status string, pelangganID *uint64) ([]Invoice, int64, error)
...
type BillingUsecase interface {
	// Invoice
	FetchInvoices(ctx context.Context, page, pageSize int, search, status string, pelangganID *uint64) ([]Invoice, int64, error)
	...
	RetryXenditInvoice(ctx context.Context, id uint64) (*Invoice, error)
