...
func (m *mockBillingUsecase) FetchLangganan(ctx context.Context, page, pageSize int, filters domain.LanggananFilterParams) ([]domain.Langganan, int64, error) {
...
func (m *mockBillingUsecase) FetchInvoices(ctx context.Context, page, pageSize int, search, status string, pelangganID *uint64) ([]domain.Invoice, int64, error) {
